...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="{{url('public')}}/assets/img/sidebar-5.jpg">
            <!--
    ...
    -->
      ...
      <footer class="footer pt-0">
        <div class="row align-items-right justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-right  text-lg-right text-muted">
      <br><br> <div class="font-weight-bold ml-1" target="_blank"><h3>WELCOME HOME MELINDA</h3></a>
            </div></div>
